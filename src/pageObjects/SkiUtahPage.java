...
//region METHODS
    /**
     *
     * @param menuItem A String representing the text of the submenu item that you want to click, i.e. "Brighton"
     ...
     */
    public Boolean ClickSubmenuItem(String menuItem, String expectedTitle)
    {
